<x-admin-layout>
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <a href="{{ route('admin.students.index') }}" class="bg-green-700 hover:bg-green-800 text-white font-bold py-2 px-4 rounded">
                « voltar
            </a>
            <div class="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
                ...
                <form action="{{ route('admin.students.update', ['student' => $item]) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="matricula" maxlength="6" name="matricula" value="{{ $item->matricula }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" required>
                    </div>
