        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
                ...
                <form action="{{ route('admin.articles.update', ['article' => $item]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <!-- Autor -->
                    <div class="mb-4">
                        <label for="autor" class="block mb-1 text-sm font-medium text-gray-700">Autor <span class="text-red-500">*</span></label>
                        <select name="autor" required class="w-full border select2 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 bg-white text-gray-700 py-2 px-4">
                    ...
                    <!-- Publicado em -->
                    <div class="mb-4">
                        <label for="publicado_em" class="block text-sm font-medium text-gray-700">Publicado em <span class="text-red-500">*</span></label>
