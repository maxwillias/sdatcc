    ...
    <x-slot name="header">
        <div class="flex">
            ...
            <div class="w-1/6 flex justify-end">
                <a href="{{ route('admin.courses.create') }}" class="bg-green-700 hover:bg-green-800 text-white font-bold py-2 px-4 rounded">
                    Novo
                </a>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden p-4 shadow-sm sm:rounded-lg border-solid border-2 border-[#5ACC58]">
            ...
            <form action="{{ route('admin.article.search') }}">
                <div class="flex items-center w-full space-x-4 bg-gray-100 p-4 rounded-lg">
                    ...
                    <input type="text" name="sigla" placeholder="Sigla" class="flex-grow px-4 py-2 text-gray-700 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                ...
                                <tr
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <div class="flex flex-col items-center">
                                            <a href="{{ route('admin.courses.edit', ['course' => $item]) }}" class="text-white bg-blue-700 hover:bg-blue-800 rounded-lg text-sm py-1 me-2 mb-2 w-[100px]">
                                                Editar
                                            </a>
                ...
                <div class="relative p-4 w-full max-w-md max-h-full">
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="p-4 md:p-5 text-center">
                            ...
                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Tem certeza que deseja excluir esse Curso, esse processo é irreversível?</h3>
                            ...
                            <form action="{{ route('admin.courses.destroy', ['course' => $item]) }}" method="POST" id="form-destroy-{{ $item->id }}" class="inline-flex">
                                @csrf
                                @method('delete')
