    ...
    <x-slot name="header">
        <div class="flex">
            ...
            <div class="w-1/6 flex justify-end">
                <a href="{{ route('admin.advisors.create') }}" class="bg-green-700 text-sm hover:bg-green-800 text-white font-bold py-2 px-4 rounded">
                    Novo
                </a>
            </div>
        </div>
                ...
                <div class="max-w-6xl mx-auto p-6 bg-gray-100 rounded-xl shadow-sm border border-gray-200">
                    <div class="flex flex-wrap gap-4">
                        <div class="flex-grow min-w-[300px]">
                            <input type="text" value="{{ request()->orientador_nome ?? null }}" name="orientador_nome" placeholder="Nome" class="w-full px-4 py-2 text-gray-700 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>
                        ...
                        <div class="flex gap-2">
                            ...
                            <a href="{{ route('admin.advisors.index') }}" class="flex items-center gap-2 px-6 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <tr
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            <div class="flex flex-col items-center">
                                                <a href="{{ route('admin.advisors.edit', ['advisor' => $item]) }}" class="text-white bg-blue-700 hover:bg-blue-800 rounded-lg text-sm py-1 me-2 mb-2 w-[100px]">
                                                    Editar
                                                </a>
                    ...
                    <div class="relative p-4 w-full max-w-md max-h-full">
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="p-4 md:p-5 text-center">
                                ...
                                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Tem certeza que deseja excluir esse Orientador, esse processo é irreversível?</h3>
                                ...
                                <form action="{{ route('admin.advisors.destroy', ['advisor' => $item]) }}" method="POST" id="form-destroy-{{ $item->id }}" class="inline-flex">
                                    @csrf
                                    @method('delete')
