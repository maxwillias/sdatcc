            ...
            <div class="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
                ...
                <form action="{{ route('admin.advisors.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="curso" name="curso" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" required>
                    </div>
