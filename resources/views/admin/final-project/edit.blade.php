            ...
            <div class="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
                ...
                <form action="{{ route('admin.final-projects.update', ['final_project' => $item]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="aluno" name="aluno" value="{{ $item->aluno }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select id="status" name="status" value="{{ $item->status }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" required>
