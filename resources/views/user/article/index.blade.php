    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mt-4">
        <form action="{{ route('user.article.search') }}">
            <div class="relative w-full max-w-md">
                <input type="text" name="search" placeholder="Digite sua busca..." class="w-full px-4 py-2 text-gray-700 bg-white border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                <button class="absolute right-2 top-1/2 transform -translate-y-1/2 bg-blue-500 text-white px-4 py-2 rounded-full hover:bg-blue-600 focus:outline-none">
                Buscar
                </button>
            </div>
        </form>
