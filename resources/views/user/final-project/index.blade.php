                                ...
                                <tr class="bg-[#CCCFD4] h-[100px] border-b dark:bg-gray-800 dark:border-gray-700 text-gray-900">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="javascript:void(0)" data-modal-toggle="modal-tcc-pdf-{{$item->id}}" data-modal-target="modal-tcc-pdf-{{$item->id}}"
                                            ...
                                            > Ver</a>
                                        <a href="{{ route('download', ['project' => $item]) }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Baixar</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <div class="relative p-4 w-full max-w-2xl max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="p-4 md:p-5 space-y-4">
                            <embed src="{{ route('embed', ['project' => $item]) }}" width="100%" height="400px" />
                        </div>
                    </div>
                </div>
            </div>
